...
const stripeConfig = {
  publishableKey: process.env.STRIPE_PUBLISHABLE_KEY || 'pk_test_placeholder_key_here',
  secretKey: process.env.STRIPE_SECRET_KEY || 'sk_test_placeholder_key_here',
  webhookSecret: process.env.STRIPE_WEBHOOK_SECRET || 'whsec_placeholder_webhook_secret_here',
